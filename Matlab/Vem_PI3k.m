...
% ----------------------------------------------------------------------------
params.PI3K_inhibitor.conc = 1.0;            % PI3K inhibitor concentration (normalized [0,1])
params.PI3K_inhibitor.IC50 = 0.5;            % IC50 for PI3K inhibition
params.PI3K_inhibitor.Hill_n = 1.5;          % Hill coefficient
...
params_vector = [
    ...
    p.PI3K_inhibitor.conc, p.PI3K_inhibitor.IC50, p.PI3K_inhibitor.Hill_n
];
...
function dydt = Mapk_ODE(t, y, p)
    ...
    PI3K_inhib_conc = p(64); IC50_PI3K = p(65); Hill_n_PI3K = p(66);
    ...
    % PI3K Inhibition Effect
    % Reduces the effective recruitment rate
    ...
    dydt(48) = -k_PI3K_recruit_eff * total_p85_RTK * y(48) ...
               + kMTOR_Feedback * y(56) * y(49);  % PI3K (p110, inactive)
    dydt(49) = k_PI3K_recruit_eff * total_p85_RTK * y(48) ...
