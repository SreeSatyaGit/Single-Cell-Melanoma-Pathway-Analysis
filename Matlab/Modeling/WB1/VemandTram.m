...
% Source: VemandTram.m (Combination Treatment)
expData_raw.panRAS = [0.967381946,1.017734223,1.0307083,1.077694732,1.298017607,1.573403892];
expData_raw.pMEK = [1.936660577,0.029380652,0.012873835,0.03390921,0.095155796,0.944936578];
expData_raw.pERK = [3.273353557,0.075717978,0.011570416,0.00642985,0.041863585,0.91621491];
expData_raw.DUSP = [2.854207662,2.842703936,1.163746208,0.332720449,0.030434242,0.094073888];
expData_raw.pEGFR = [0.222379739,0.622877159,0.629217784,0.533530834,0.022513609,0.010036399];
expData_raw.pCRAF = [0.234376572,0.641878896,0.567434544,0.406320223,0.582899195,0.25113447];
expData_raw.pAKT = [0.527301325,0.614645732,0.95895017,0.895019432,0.412820453,0.269891704];
expData_raw.p4ebp1 = [0.793559668,1.176099875,1.210864904,1.415698564,0.858543042,0.167293554];
expData_raw.pS6k = [1.385578651,1.388228355,1.286010223,0.720958901,0.12299088,0.028906108];
expData_raw.her2 = [0.306924546,0.275751955,0.32171108,0.23070312,1.013023288,1.045536401];
expData_raw.her3 = [0.295284147,0.285719072,0.385045943,0.582261781,0.751301308,0.264889608];
expData_raw.pDGFR = [0.583361128,0.585284809,0.785897279,1.208147444,2.298226921,2.387788835];
...
fprintf('Running GlobalSearch for Combination Model...\n');
tic;
...
model_smooth.panRAS = min_max_norm(Y_fine(:,16) + Y_fine(:,18) + Y_fine(:,21)); % FIXED: y(21)
...
function dydt = Mapk_ODE(t, y, p)
    ...
    % Using kdegrad (p26) for RAS deactivation (GAP activity)
    ...
    % Activation by panRAS_active (using corrected index 21)
    ...
    % Feedback & PI3K Module (Same as unified model)
